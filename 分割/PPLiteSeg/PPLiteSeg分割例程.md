...
![image-20221127215435644](docs.assets/image-20221127215435644.png)
...
![image-20221127220422997](docs.assets/image-20221127220422997.png)
...
​		该配置是基于`Cityscapes`构建的，那我们自己创建好数据集，应该如何进行修改呢？
​		如下给出一个自定义数据集
